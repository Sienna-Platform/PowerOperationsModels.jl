...
"""
function constraint_voltage_magnitude_bounds(
...
function constraint_gen_setpoint_active(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_gen_setpoint_reactive(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_gen_active_bounds(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_gen_reactive_bounds(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_voltage_magnitude_setpoint(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_network_power_balance(
    ...
    comp_gs =
        Dict(shunt["index"] => (shunt["shunt_bus"], shunt["gs"]) for shunt in comp_shunts)
    comp_bs =
        Dict(shunt["index"] => (shunt["shunt_bus"], shunt["bs"]) for shunt in comp_shunts)
...
function constraint_power_magnitude_link(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_power_magnitude_link_on_off(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
"""
function constraint_thermal_limit_from(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_thermal_limit_to(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
"""
function constraint_current_limit_from(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
"""
function constraint_current_limit_to(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
function constraint_switch_thermal_limit(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
...
"""
function constraint_storage_complementarity_nl(
    pm::AbstractPowerModel,
    i::Int;
    nw::Int = nw_id_default,
)
