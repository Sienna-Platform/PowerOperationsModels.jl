...
get_variable_multiplier(::Type{V}, ::Type{D}, ::Type{F}) where {V <: FlowActivePowerVariable, D <: PSY.TwoTerminalHVDC, F <: AbstractTwoTerminalDCLineFormulation} = _unsupported_multiplier(V, D, F)
