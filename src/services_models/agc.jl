...
function add_constraints!(
    ...
    ::Type{T},
    ::Type{LiftVariable},
    agcs::Union{Vector{U}, IS.FlattenIteratorWrapper{U}},
...
function add_to_objective_function!(
    container::OptimizationContainer,
    agcs::Union{Vector{T}, IS.FlattenIteratorWrapper{T}},
...
function add_feedforward_arguments!(
    ...
    areas::Union{Vector{PSY.AGC}, IS.FlattenIteratorWrapper{PSY.AGC}},
)
