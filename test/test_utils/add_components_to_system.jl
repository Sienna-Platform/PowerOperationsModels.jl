function get_copied_line(
    ...
    copied_line = Line(;
        ...
        reactive_power_flow = PSY.get_reactive_power_flow(line, PSY.SU),
        ...
        rating_c = PSY.get_rating_c(line, PSY.SU),
...
function add_equivalent_ac_transmission_with_parallel_circuits!(
    ...
    ac_transmission_copy = MonitoredLine(;
        ...
        reactive_power_flow = PSY.get_reactive_power_flow(ac_transmission, PSY.SU),
